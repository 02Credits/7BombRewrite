...
{
  internal class ExplosionPowerup : IPowerup
  {
    private static Color powerUpColor = new Color((int) byte.MaxValue, 200, 0);
    ...
    public Color PowerUpColor
    {
      get
      {
        return ExplosionPowerup.powerUpColor;
      }
    }
    ...
    public ExplosionPowerup(World world, Vector2 startPosition)
    {
      ...
      FixtureFactory.AttachPolygon(circle, 1f, this.PowerUpBody, (object) ExplosionPowerup.powerUpColor);
      this.Timer = 0.0f;
    }
  }
}
